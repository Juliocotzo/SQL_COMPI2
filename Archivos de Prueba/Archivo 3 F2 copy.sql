...
SELECT CALCULOS();
insert into tbCalificacion values(3,' Valida Funciones',8);

create table tbbodega (idbodega integer not null primary key,
					   bodega varchar(100) not null,
					   estado integer);
								  
CREATE INDEX index_lower ON tbbodega (lower(bodega));
...
insert into tbCalificacion values(4,'Valida Store Procedure',2);
