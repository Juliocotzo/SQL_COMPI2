...
SELECT 'VALIDA SUB QUERY';*/
SELECT * FROM tbempleado E,tbestado ES 
WHERE ES.idestado = E.idestado;
SELECT * FROM tbempleado E,tbempleadoidentificacion I
WHERE I.idempleado = E.idempleado;
SELECT * FROM tbidentificaciontipo IT,tbempleadoidentificacion I
WHERE IT.ididentificaciontipo = I.ididentificaciontipo;
/*
...
SELECT 'VALIDA QUERYS MULTIPLES';
...
select SQRT(225) AS 'SQRT',SIGN(14.321) AS 'SING',PI(),TRUNC(67.456) AS 'TRUNC', RANDOM() AS 'RANDOM',
...
select ATAN(1),ASIN(1),ATAND(0),ACOS(1),ACOSD(1),ASIN(1),ASIND(0),COS(0),TAN(0),SINH(2),ACOSH(2),ATANH(0),TANH(1);

/*SELECT length(primernombre),substring(primerapellido,1,5),substr(primerapellido,1,5)
FROM tbempleado*/
SELECT length('Julio'),substring('Manuel',0,2),substr('Dulce',0,3);
...
select * 
from tbempleado
where primernombre like  'Julio';

select * 
from tbempleado
where primernombre NOT like  'Julio';
